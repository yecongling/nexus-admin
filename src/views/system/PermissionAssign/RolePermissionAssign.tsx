...
const RolePermissionAssign: React.FC = () => {
  ...
  const assignPermissionMutation = useMutation({
    mutationFn: ({ permissionType, permissionIds }: { permissionType: 'menu' | 'button' | 'interface'; permissionIds: string[] }) =>
      permissionService.assignRolePermission(selectedRoleId || '', permissionType, permissionIds),
    onSuccess: () => {
  ...
  const handleSavePermissions = useCallback(() => {
    ...
    const permissionIds = activeTab === 'menu' ? menuCheckedKeys : 
                         activeTab === 'button' ? buttonCheckedKeys : 
  ...
  }, [selectedRoleId, activeTab, menuCheckedKeys, buttonCheckedKeys, interfaceCheckedKeys, assignPermissionMutation]);
      ...
      case 'menu':
        return (
          <MenuPermissionTree
            ...
            onCheck={handleMenuPermissionChange}
          />
        );
      case 'button':
        return (
          <ButtonPermissionTree
            checkedKeys={buttonCheckedKeys}
            onCheck={handleButtonPermissionChange}
          />
        );
      case 'interface':
        return (
          <InterfacePermissionGrid
            checkedKeys={interfaceCheckedKeys}
            onCheck={handleInterfacePermissionChange}
          />
        );
      default:
        return null;
